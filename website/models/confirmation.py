...
class Confirmation(db.Model):
    ...
    church_baptized = db.Column(db.String(255), nullable=False)
    ...
    # Relationships
    user = db.relationship('User', back_populates='confirmation', lazy=True)
    record = db.relationship('Record', back_populates='confirmation', lazy=True)
